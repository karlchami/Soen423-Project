...
public class ReturnItem {
    ...
    private ReturnItemResponseDetails responseDetails;

    public ReturnItem(String JSONString){
        try{
            JSONParser jp = new JSONParser();
            JSONObject JObject = (JSONObject) jp.parse(JSONString);
            this.responseDetails = new ReturnItemResponseDetails(JObject.get("response_details").toString());
    ...
    public ReturnItemResponseDetails getResponseDetails() {
        return responseDetails;
    }

    public void setResponseDetails(ReturnItemResponseDetails responseDetails) {
